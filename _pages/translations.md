...
| | LGBTQI+ | an overly bloated acronym that looks ridiculous, especially considering that Q+ covers the not previously mentioned in LGBT identities |
| | LGBTQIA+ | |
| | LGBTQIAAP+ | |
...
| | a transsexualist | |
| | a transvestite | |
| transgender (adj.) | transgendered | degoratory |
...
| trans man | transman | same as above, but the words are written separately |
| | trans-man | |
| | trans*man | |
...
| homosexual (adj.), etc. | homo-sexual, etc. | no hyphens |
...
| to out sb | to disclose sb's identity to sb | there is such a good term for this, so, please, use it |
| | to reveal sb's identity to sb | |
| "non-traditional sexual relationships propaganda" | "non-traditional sexual relationships propaganda" | anything that refers to "propaganda" should be in quotes |
