...
Занятия со мной включают в себя:
* **возможность задавать мне любые вопросы практически 24/7.**
* **циклический подход: отработка теории – отработка курсового учебника – отработка тестов**.
* **мега-качественные разборы письменных работ** (см. пример ниже). 
...
* Переносы/отмены занятий согласовываются в любой момент.
* Регулярные занятия дешевле.
