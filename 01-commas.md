...
:::{prf:example} Инверсия: модификатор в начале предложения 

Самые частые случаи, когда происходит {term}`инверсия` объекта — мы хотим
сконцентрировать внимание на объекте, поставив его в
начало:
Длинные объекты из более чем трёх слов всегда рекомендуется
выделять запятыми, чтобы повысить читаемость:
● In Autumn of 2023, I wrote this guide.
Однако это не есть обязательно, если мы хотим особенно сильно
связать смысл объекта и последующей части предложения, если у нас
неформальный стиль или если объект очень короткий и его отделение
запятой выглядит неестественно (здесь можно ставить или не ставить
запятую по желанию, чётких правил прям нет, но я рекомендую
ставить, если это допустимо, особенно в формальных текстах):
