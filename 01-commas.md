...
- [ ] Запятые между однородными придаточными
- [ ] Ограничивающие/неограничивающие приложения по аналогии с оборотами
- [ ] Заканчивающие конструкции по аналогии с вводными
- [ ] Точка с запятой чтобы избегать повтора (вместо тире в русском)
- [ ] Точка с запятой между основами с however/therefore/так далее
- [ ] Возможно более чётко написать про разделение списков с точкой с запятой
- [ ] Всю стилистику
- [ ] Точку с запятой в случае со списками и двоеточие
- [ ] Кавычки, скобки
:::
